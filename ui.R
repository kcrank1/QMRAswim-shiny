...
fluidPage(theme=shinytheme("spacelab"),
  ...
  tagList(
    ...
    p(),
    p(" Crank, K., Petersen, S., Bibby, K. (2019). Quantitative Microbial Risk Assessment of Swimming in Sewage Impacted Waters Using CrAssphage and Pepper Mild Mottle Virus Indicators in a Customizable Model. Environ. Sci. Technol. Lett. 10.1021/acs.estlett.9b00468"),
    p(),
